...
def recommend_process(data_integration_ref: dict, problem_definition: dict, fetch_data_query: str,
    ...
    profiler.set_meta(query='recommend_process', api='http', environment=Config().get('environment'))
    with profiler.Context('recommend_process'):
    ...
    try: 
        ...
        ml_handler.recommend(target, df=training_data_df, args=problem_definition) 
