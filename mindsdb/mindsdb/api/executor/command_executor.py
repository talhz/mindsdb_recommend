...
class ExecuteCommands:
    ...
    def execute_command(self, statement, database_name: str = None) -> ExecuteAnswer:
        sql = None
        logger.warning(f"The type of the statement is: {type(statement)}")
        ...
        elif type(statement) is RecommendModel:
            logger.warning("Query recognized!")
            return self.answer_recommend_model(statement, database_name)
        else:
